...
class QueuedTrainer(object):
    ...
    training steps using a tf.queue.FIFOQueue.
    ...
    def run(self, feed_generator, train_op, log_dir="./tmp/slim_trainer/",
        ...
        if restore_path is not None:
            ...
            self._init_fns.append(lambda sess: sess.run(init_assign_op, init_feed_dict))
        ...
        try:
            slim.learning.train(
                ...
                **kwargs)    #  session_config=tf.compat.v1.ConfigProto(allow_soft_placement=True),
